...
class Renderer:
    ...
    def add_opt(self, opt, pad=0, opt_size=0, tsig_size=0):
        ...
        if pad:
            ...
            opt = dns.message.Message._make_opt(ttl, opt_rdata.rdclass, options)  # pyright: ignore
    ...
    def add_edns(self, edns, ednsflags, payload, options=None):
        ...
        ednsflags |= edns << 16
        opt = dns.message.Message._make_opt(ednsflags, payload, options)  # pyright: ignore
        self.add_opt(opt)
