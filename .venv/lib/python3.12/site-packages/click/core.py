...
class Command:
    ...
    def get_params(self, ctx: Context) -> list[Parameter]:
        ...
        if __debug__:
            ...
            duplicate_names = (name for name, count in names_counter.items() if count > 1)
...
class Option(Parameter):
    ...
    def __init__(
        ...
        **attrs: t.Any,
        ...
        self.is_flag, self._flag_needs_value = self._infer_flag_kind(is_flag, flag_value)
    ...
    def _infer_flag_kind(self, is_flag: bool | None, flag_value: t.Any) -> tuple[bool, bool]:
    ...
    def consume_value(
        ...
        # activation value.
            ...
            value = [self.flag_activation_value if v is FLAG_NEEDS_VALUE else v for v in value]
            source = ParameterSource.COMMANDLINE
