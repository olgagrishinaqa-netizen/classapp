...
class AsyncWorker(base.Worker):
        ...
        try:
            ...
            try:
                ...
                if not self.cfg.keepalive:
                    req = next(parser)
                    if self._try_h2c_upgrade(listener, req, parser, client, addr):
                        return
    ...
    def _try_h2c_upgrade(self, listener, req, parser, client, addr):
        ...
        self.handle_http2(listener, client, addr, preface=pending, upgrade=(settings, req, body))
        return True
    ...
    def handle_http2(self, listener, client, addr, preface=b"", upgrade=None):
        ...
        try:
            ...
            if upgraded is not None:
                ...
                self.handle_http2_request(listener.getsockname(), upgraded, client, addr, h2_conn)
