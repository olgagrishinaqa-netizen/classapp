...
class HTTP2ServerConnection:
    ...
    def send_response_headers(self, stream_id, status, headers, end_stream=False):
    ...
    def send_response(self, stream_id, status, headers, body=None):
        ...
        try:
            if not self.send_response_headers(stream_id, status, headers, end_stream=end_stream):
                return False
