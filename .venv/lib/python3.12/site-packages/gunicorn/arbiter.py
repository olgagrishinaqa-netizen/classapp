        ...
        if self.log is None:
            ...
            try:
                ...
                try:
                    ...
                    print(
                        "Error: restoring the previous logger " "configuration failed",
                        file=sys.stderr,
                    )
                    traceback.print_exc()
                    sys.stderr.flush()
                    ...
                    self.log.error(
                        "reloading the logger configuration " "failed, keeping the previous one"
                    )
        ...
        try:
            while True:
                ...
                if self.reexec_pid == wpid:
                    ...
                    if worker is None:
                        self.log.debug(
                            "Reaped unknown child process (pid:%s, status:%s)", wpid, status
                        )
                        continue
