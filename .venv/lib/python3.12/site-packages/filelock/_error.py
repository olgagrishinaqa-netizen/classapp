...
class Timeout(
    TimeoutError
):  # ruff:ignore[error-suffix-on-exception-name]  # public exception name; renaming breaks the API
...
class SoftFileLockProtocolError(OSError):
    ...
    def __reduce__(
        ...
        type[SoftFileLockProtocolError], tuple[str, str | None, str]
    ...
    def __str__(self) -> str:
        location = (
            ...
            else f"{self._lock_file}: claim {self._claim_name!r}"
        )
