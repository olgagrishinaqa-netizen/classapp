...
class AsyncFileLockMeta(FileLockMeta):
    def __call__(  # ruff:ignore[too-many-arguments]  # forwards the public constructor's documented parameters
        ...
        **kwargs: _ExtraValue,
        ...
        return (
            super().__call__(  # a subclass may add options of its own, as AsyncSoftFileLease does
                **kwargs,
                lock_file=lock_file,
                timeout=timeout,
                mode=mode,
...
class BaseAsyncFileLock(BaseFileLock, metaclass=AsyncFileLockMeta):
    ...
    def _raise_acquire_rollback_errors(
        ...
        if self._context_error_policy == "group":
            _raise_grouped_errors(
                "lock acquisition backend and rollback both failed", acquire_error, rollback_error
            )
    ...
    def _start_internal_method(
        ...
        if iscoroutinefunction(method):
            return asyncio.create_task(
                _capture_awaitable(cast("Callable[[], Coroutine[None, None, None]]", method)())
            )
            ...
            if (
                ...
                match errors:
                    ...
                    case (
                        ...
                        _raise_grouped_errors(
                            _ASYNC_CONTEXT_RELEASE_ERRORS, body_error, cancellation, backend_error
                        )
...
class AsyncAcquireReturnProxy:
    ...
    async def __aenter__(
        self,
    ) -> BaseAsyncFileLock:  # ruff:ignore[undocumented-magic-method]  # returns the wrapped lock
        return self.lock
