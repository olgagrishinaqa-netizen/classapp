...
if sys.platform == "win32":  # pragma: win32 cover
    ...
    _CREATE_OPTIONS: Final[int] = (
        _FILE_SYNCHRONOUS_IO_NONALERT | _FILE_NON_DIRECTORY_FILE | _FILE_OPEN_REPARSE_POINT
    )
    ...
    def _nt_open(path: str, *, read_only: bool) -> tuple[int, int]:
        ...
        status = (
            _ntdll.RtlDosPathNameToNtPathName_U_WithStatus(path, ctypes.byref(nt_name), None, None)
            & 0xFFFFFFFF
        )
        if status != _STATUS_SUCCESS:
            return 0, status
