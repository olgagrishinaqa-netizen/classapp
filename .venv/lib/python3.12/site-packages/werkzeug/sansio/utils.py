...
def host_is_trusted(hostname: str | None, trusted_list: t.Collection[str] | None = None) -> bool:
...
def get_content_length(
    ...
    """
    if (
        http_transfer_encoding is not None and "chunked" in parse_set_header(http_transfer_encoding)
