...
class ScriptDirectory:
    ...
    def _downgrade_revs(self, destination: str, current_rev: str | None) -> list[RevisionStep]:
        with self._catch_revision_errors(
...
class Script(revision.Revision):
    ...
    @classmethod
    def _from_path(cls, scriptdir: ScriptDirectory, path: str | os.PathLike[str]) -> Script | None:
