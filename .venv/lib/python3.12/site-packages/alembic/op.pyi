...
def implementation_for(op_cls: Any, replace: bool = False) -> Callable[[_C], _C]:
...
def inline_literal(value: str | int, type_: TypeEngine[Any] | None = None) -> _literal_bindparam:
...
def register_operation(name: str, sourcename: str | None = None) -> Callable[[type[_T]], type[_T]]:
