...
def current(config: Config, check_heads: bool = False, verbose: bool = False) -> None:
    ...
    def display_version(rev, context):
        ...
        if check_heads and (set(context.get_current_heads()) != set(script.get_heads())):
            raise util.DatabaseNotAtHead("Database is not on all head revisions")
