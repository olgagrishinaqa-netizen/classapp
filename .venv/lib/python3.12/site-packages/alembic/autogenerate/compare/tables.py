...
def _compare_tables(
    ...
    for s, tname in metadata_table_names.difference(conn_table_names):
        ...
        if autogen_context.run_object_filters(metadata_table, tname, "table", False, None):
            ...
            autogen_context.comparators.dispatch("table", qualifier=autogen_context.dialect.name)(
                autogen_context,
                modify_table_ops,
                s,
                tname,
...
def _compare_columns(
    ...
    for colname in metadata_col_names.intersection(conn_col_names):
        ...
        autogen_context.comparators.dispatch("column", qualifier=autogen_context.dialect.name)(
            autogen_context,
            alter_column_op,
            schema,
            tname,
