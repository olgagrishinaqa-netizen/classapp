...
def _produce_net_changes(autogen_context: AutogenContext, upgrade_ops: UpgradeOps) -> None:
    ...
    autogen_context.comparators.dispatch("autogenerate", qualifier=autogen_context.dialect.name)(
...
Plugin.setup_plugin_from_module(constraints, "alembic.autogenerate.constraints")
Plugin.setup_plugin_from_module(server_defaults, "alembic.autogenerate.defaults")
...
Plugin.setup_plugin_from_module(checkconstraint_byname, "alembic.ext.checkconstraint_byname")
