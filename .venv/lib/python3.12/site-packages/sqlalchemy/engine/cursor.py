...
class CursorResultMetaData(ResultMetaData):
    ...
    def _for_freeze(self) -> ResultMetaData:
        ambiguous = {rec[MD_LOOKUP_KEY] for rec in self._keymap.values() if rec[MD_INDEX] is None}
    ...
    def __init__(
        ...
        if num_ctx_cols:
            ...
            if len(by_key) != num_ctx_cols:
                ...
                # record into by_key.
                by_key.update({key: (None, -1, (), key, key, None, None) for key in dupes})
    ...
    def _index_for_key(self, key: _KeyIndexType, raiseerr: bool = True) -> Optional[int]:
...
class BufferedRowCursorFetchStrategy(CursorFetchStrategy):
    ...
    def _buffer_rows(self, result: CursorResult[Any], dbapi_cursor: DBAPICursor) -> None:
