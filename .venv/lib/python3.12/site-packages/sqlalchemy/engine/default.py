...
class DefaultDialect(Dialect):
    ...
    def do_rollback(self, dbapi_connection):
        if self.skip_autocommit_rollback and self.detect_autocommit_setting(dbapi_connection):
            return
...
class DefaultExecutionContext(ExecutionContext):
    ...
    _translate_colname: Optional[Callable[[str], Tuple[str, Optional[str]]]] = None
