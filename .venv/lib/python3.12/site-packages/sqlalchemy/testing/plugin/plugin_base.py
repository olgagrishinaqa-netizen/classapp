...
def generate_sub_tests(cls, module, markers):
    if "backend" in markers or "sparse_backend" in markers or "sparse_driver_backend" in markers:
        sparse = "sparse_backend" in markers
        sparse_driver = "sparse_driver_backend" in markers
        for cfg in _possible_configs_for_cls(cls, sparse=sparse, sparse_driver=sparse_driver):
    ...
    if hasattr(cls, "__requires__"):
        ...
        for config_obj in list(all_configs):
            for requirement in cls.__requires__:
                ...
                if warnings:
                    cls.__warnings__ = getattr(cls, "__warnings__", ()) + tuple(warnings)
