    ...
    def visit_insert(self, insert_stmt, visited_bindparam=None, visiting_cte=None, **kw):
        ...
        if insert_stmt.select is not None:
            ...
            if (
                ...
                insert_crud_params = [
                    elem for elem in crud_params_single if elem[0] not in add_sentinel_set
                ]
            ...
            insert_single_values_expr = ", ".join([value for _, _, value, _ in crud_params_single])
...
class DDLCompiler(Compiled):
    ...
    def define_primary_key_body(self, constraint: PrimaryKeyConstraint, **kw: Any) -> str:
        text = ""
        text += "PRIMARY KEY "
        text += "(%s)" % ", ".join(
    ...
    def define_foreign_key_body(self, constraint: ForeignKeyConstraint, **kw: Any) -> str:
        preparer = self.preparer
