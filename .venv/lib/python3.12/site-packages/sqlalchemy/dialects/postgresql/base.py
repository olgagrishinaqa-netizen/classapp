...
class PGCompiler(compiler.SQLCompiler):
    ...
    def visit_on_conflict_do_update(self, on_conflict, **kw):
        ...
        if clause.update_whereclause is not None:
            ...
            action_text += " WHERE %s" % self.process(clause.update_whereclause, **where_kw)
...
class PGExecutionContext(default.DefaultExecutionContext):
    def fire_sequence(self, seq, type_):
        return self._execute_scalar(
            ("select nextval(%s)" % self.identifier_preparer._format_sequence_string_literal(seq)),
            type_,
        )
...
class PGDialect(default.DefaultDialect):
    ...
    def _columns_query(self, schema, has_filter_names, scope, kind):
        ...
        collate = sql.case(
            (
                ...
                .where(pg_catalog.pg_collation.c.oid == pg_catalog.pg_attribute.c.attcollation)
                .correlate(pg_catalog.pg_attribute)
                .scalar_subquery(),
            ),
            else_=sql.null(),
    ...
    def _parse_fk(self, condef):
        ...
        onupdate = (
            upddelval1 if upddelkey1 == "UPDATE" else upddelval2 if upddelkey2 == "UPDATE" else None
        )
        ondelete = (
            upddelval1 if upddelkey1 == "DELETE" else upddelval2 if upddelkey2 == "DELETE" else None
        )
    ...
    def _index_query(self):
        ...
        cols_sq = (
            select(
                ...
                sql.func.array_agg(aggregate_order_by(attr_sq.c.opcname, attr_sq.c.ord)).label(
                    "elements_opclass"
                ),
                sql.func.array_agg(aggregate_order_by(attr_sq.c.opcdefault, attr_sq.c.ord)).label(
                    "elements_opdefault"
                ),
            )
