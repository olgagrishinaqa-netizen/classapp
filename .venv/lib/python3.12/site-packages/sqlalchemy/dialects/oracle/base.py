...
class OracleTypeCompiler(compiler.GenericTypeCompiler):
    ...
    def visit_VECTOR(self, type_, **kw):
        ...
        storage_format = type_.storage_format.value if type_.storage_format is not None else "*"
        storage_type = type_.storage_type.value if type_.storage_type is not None else "*"
